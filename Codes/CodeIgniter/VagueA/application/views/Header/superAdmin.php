            ...
            <div class="header-container"> 
                ...
                <div class="collapse navbar-collapse navbar-menubuilder">
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li class="dropdown"><a href="#Calendar" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>  Calendar<b class="caret"></b>
                                </a>
                            ...
                            <li class="divider"></li>
                            <li><a tabindex="-1" href="<?php echo base_url(); ?>user/GanseCal"></span><i class="fa fa-university"></i>  Gansewinkel Hall</a></li>
                            <li class="divider"></li>
                            <li><a tabindex="-1" href="<?php echo base_url(); ?>user/BuchCal"></span><i class="fa fa-university"></i>  Buchick Hall</a></li>
                    
                    </ul>
                                </li>
                                <li><a href="<?php echo base_url(); ?>user/reservationList"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>Reservation</a>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="<?php echo base_url(); ?>StaffWS/hall"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>  AV Hall</a></li>
                            <li class="divider"></li>
                            ...
                            <li class="divider"></li>
                            <li><a tabindex="-1" href="<?php echo base_url(); ?>superAdmin/staff"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>  Staff</a></li>
                            <li class="divider"></li>
