      ...
      <div class="row">
       ...
       <header><!-- Header -->
        ...
        <div class="collapse navbar-collapse navbar-menubuilder">
                ...
                <li class=""><a href="<?php echo base_url(); ?>endorseapprove/formConfirmationApprove"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>  Approve Bookings</a></li>
                            </ul>
