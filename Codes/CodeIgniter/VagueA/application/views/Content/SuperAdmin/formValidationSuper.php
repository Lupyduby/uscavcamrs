      ...
      <div class="reservation-form">
        ...
        <div class="col-md-12 validate-content">
            ...
            <div style="left:10%; top:15%;">
              <form method="POST" action="<?php echo base_url(); ?>superAdmin/addreservation">
              ...
              <table>
                ...
                ?>
                <tr height="50">
                   <td><label for="oldpass">ID Number</label></td>
                    <td><input type="text" class="form-control-general" id="confirmpass" name="userID" ></td>
                </tr>
                <tr height="50">
