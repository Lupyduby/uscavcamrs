        ...
        <div class="table-responsive">
          <table id="table_id" class="display">
            <thead class="theader-contents">
              ...
              <?php if($this->session->userdata('type')!="Super" && $this->session->userdata('type')!="VPA" && $this->session->userdata('type')!="VPA" && $this->session->userdata('type')!="Dean") 
                    echo "<th id='oneLineTd'><h4>Endorsed by</h4></th>"; ?>
                <?php if($this->session->userdata('type')!="Super" && $this->session->userdata('type')!="VPA" && $this->session->userdata('type')!="VPA") 
            ...
            <tbody class="table-contents">
              ...
              ?>
                <tr>
                    ...
                    <?php 
                      if($this->session->userdata('type')!="Super" && $this->session->userdata('type')!="VPA" && $this->session->userdata('type')!="VPA" && $this->session->userdata('type')!="Dean") 
