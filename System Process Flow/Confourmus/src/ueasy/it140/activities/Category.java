...
import ueasy.it140.specificCategories.FacilitiesCategory;
import ueasy.it140.specificCategories.FoodAndBeveragesCategory;
import ueasy.it140.specificCategories.OfficesCategory;
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (n.equals("Room")) {
					...
					i = new Intent(getApplicationContext(), BuildingCategory.class);
					i.putExtra("name", n);
					startActivity(i);
				}
				else if (n.equals("Food and Beverages")){
					i = new Intent(getApplicationContext(), FoodAndBeveragesCategory.class);
					i.putExtra("name", n);
					startActivity(i);
				}
				else if (n.equals("Facilities")){
					i = new Intent(getApplicationContext(), FacilitiesCategory.class);
					i.putExtra("name", n);
					startActivity(i);
				}
				else{
					i = new Intent(getApplicationContext(), OfficesCategory.class);
					i.putExtra("name", n);
					startActivity(i);
				}
			}
